...
# Resoving conflicting functions 
...
`sqldf` has ben used to use SQL code in R. `tidyquery` is a good alternative because it has fewer dependencies.
...
Also, note that you can combine `sqldf` and `dplyr`.
